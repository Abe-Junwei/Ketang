...
import { apiAssignBed, apiAssignReservationToBed } from '../../_shared/lodgers.js';
...
export async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    if (body.reservation_id) return json(await apiAssignReservationToBed(env, session, body));
    return json(await apiAssignBed(env, session, body));
  } catch (error) {
