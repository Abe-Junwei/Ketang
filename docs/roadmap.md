...
2. **当前主线：Phase 2（P1-1）** — 两端同时登录，跑入住、换床、退房、用斋、房态刷新与并发占床测试。
3. Phase 3 权限可视化与 Phase 11 性能基线穿插推进。
4. Phase 7 日常规则补强放在真实数据稳定使用后继续。
5. Phase 4 公开预约仍后置，待多人验收与权限收口完成。
6. Phase 8-9 移动端与夏季排房依赖 Phase 2/7 结果。
7. Phase 10 继续暂缓。
