...
def main() -> int:
    checks = [
        ...
        ("metrics probe api", "storeProbeBatch" in read("functions/api/v1/metrics/probe.js")),
        ("timing observe", "observe(env, request, meta)" in read("functions/_shared/timing.js")),
