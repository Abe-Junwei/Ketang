...
def main() -> None:
    ...
    checks = [
        ...
        ("rum write reconcile", "write-reconcile" in rum and "write-visible-refresh" in rum),
        ...
        ("metrics perf summary get", "onRequestGet" in perf_api and "aggregatePerfRumSummary" in perf_api),
        ("rum summary by page", "by_page" in store and "aggregatePerfRumSummary" in store),
