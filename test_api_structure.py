...
REQUIRED = [
    ...
    'functions/_shared/read-modules.js',
    'functions/_shared/sync-meta.js',
    'functions/_shared/sync-delta.js',
    'functions/_shared/write-response.js',
    'functions/_shared/permissions.js',
    'functions/_shared/timing.js',
    'functions/_shared/perf-rum-store.js',
    'functions/_shared/password.js',
    'functions/_shared/cookies.js',
    'functions/_shared/refresh-sessions.js',
    'functions/_shared/auth-response.js',
    'functions/_shared/auth-login.js',
    'functions/api/db.js',
    ...
    'functions/api/v1/read/[module].js',
    'functions/api/v1/read/settings/[resource].js',
    'functions/api/v1/read/event/[id].js',
    'functions/api/v1/sync/delta.js',
    'functions/api/v1/metrics/perf.js',
    'functions/api/v1/stream/board.js',
